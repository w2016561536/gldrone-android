...
public class MAV_RESULT {
   ...
   public static final int MAV_RESULT_NOT_IN_CONTROL = 10; /* Command has been rejected because source system is not in control of the target system/component. | */
   public static final int MAV_RESULT_ENUM_END = 11; /*  | */
}