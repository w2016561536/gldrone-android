...
public class Drone_Command {
    ...
    public static void STATUS() {
        new Thread(() -> {
            ...
            com.gldz.gldrone.MAVLinkConnection.Send(STATUS_Position);
            ...
            com.gldz.gldrone.MAVLinkConnection.Send(STATUS_Battery);
            ...
            com.gldz.gldrone.MAVLinkConnection.Send(STATUS_Speed);
            ...
            com.gldz.gldrone.MAVLinkConnection.Send(STATUS_System);
            ...
            com.gldz.gldrone.MAVLinkConnection.Send(STATUS_Attitude);
            ...
            com.gldz.gldrone.MAVLinkConnection.Send(STATUS_gps);
        }).start();
    }
    ...
    public static void ARM_DISARM_FUNCTION(int is_armed) {
        new Thread(() -> {
            ...
            com.gldz.gldrone.MAVLinkConnection.Send(cmd);
        }).start();
    }
    ...
    public static void GOTO_FUNCTION(double lat, double lng, float alt) {
        new Thread(() -> {
            ...
            com.gldz.gldrone.MAVLinkConnection.Send(mission);
        }).start();
    }
