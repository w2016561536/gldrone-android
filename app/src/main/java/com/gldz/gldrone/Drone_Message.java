...
public class Drone_Message {
    ...
    public void Message_classify(MavlinkMessage message){
        ...
        CharSequence timestamp = DateFormat.format("yyyy-MM-dd kk:mm:ss", mCal.getTime());
        ...
        if (message.getPayload() instanceof Heartbeat) {
            ...
            if(mav_type_.equals("MAV_TYPE_QUADROTOR"))
            {
                ...
                String str_arm_disarm;
                if(arm_disarm == '0'){
                    str_arm_disarm = "Disarmed";
                }
                else {
                    str_arm_disarm = "Armed";
                }
        ...
        // GLOBAL_POSITION_INT ( #33 )
            ...
            mHandler.obtainMessage(202, "Lat: " + lat + ", LNG: " + lng + ", ALT: " + relative_alt).sendToTarget();
        ...
        // SYS_STATUS ( #1 )
            ...
            mHandler.obtainMessage(204, volt + " V, " + current + " A, " + percentage +" %").sendToTarget();
        ...
        // VFR_HUD ( #74 )
            ...
            mHandler.obtainMessage(203, air_speed + " m/s ").sendToTarget();
        ...
        // COMMAND_ACK ( #77 )
            ...
            mHandler.obtainMessage(300, timestamp + what_cmd).sendToTarget();
            mHandler.obtainMessage(301, timestamp + cmd_result).sendToTarget();
        }
        // STATUSTEXT ( #256 )
        ...
        // MISSION_ACK ( #47 )
            ...
            mHandler.obtainMessage(300, timestamp + "MAVLink Flight Mission").sendToTarget();
            mHandler.obtainMessage(301, timestamp + mission_result).sendToTarget();
